...
const machine = Object(xstate__WEBPACK_IMPORTED_MODULE_2__["Machine"])({
    id: 'watch',
    context: {},
    type: 'parallel',
    states: {
...
const service = Object(xstate__WEBPACK_IMPORTED_MODULE_2__["interpret"])(machine);
const state$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["fromEventPattern"])((handler) => {
...
module.exports = __webpack_require__(/*! /Users/doup/Code/doup-statewatch/src/main.ts */"./src/main.ts");
